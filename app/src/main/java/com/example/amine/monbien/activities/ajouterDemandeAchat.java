...
public class ajouterDemandeAchat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajouter_demande_achat);
    ...
    public void clickback(View view) {
        Intent intent = new Intent(ajouterDemandeAchat.this, ajouterdemandeoffer.class);
        startActivity(intent);
    }
    private void ajouterdemandeachat() {
        ...
        if (checkInternetConnection(getApplicationContext())){
            ...
            demandeachat demachat = new demandeachat(id, numtel, nom,typebien,nbchambre,nbetage,region,ville,prix,remarque,currentDateTimeString,username);
            databaseReference.child(id).setValue(demachat);

            Toast.makeText(ajouterDemandeAchat.this,
                    "une demande d'achat est ajouteé ",
                    Toast.LENGTH_SHORT).show();
        }else {
            demandeachat demandeAchat = new demandeachat(numtel, nom,typebien,nbchambre,nbetage,region,ville,prix,remarque,currentDateTimeString,username);
            DemandeAchatDAO dao = new DemandeAchatDAO(ajouterDemandeAchat.this);


            long idInsert = dao.insertDemandeAchat(demandeAchat);
            Toast.makeText(ajouterDemandeAchat.this, "une demande d'achat est ajouteé (HORS_LIGNE)",Toast.LENGTH_SHORT).show();
        ...
        if (PhonecallReceiver.fromDialog==true){
            ...
            Intent myintent = new Intent(ajouterDemandeAchat.this, ajouterdemandeoffer.class);
            startActivity(myintent);
        }


    }
    public void clickconfirmerajouterdemandeachat (View view) {
        ajouterdemandeachat();
