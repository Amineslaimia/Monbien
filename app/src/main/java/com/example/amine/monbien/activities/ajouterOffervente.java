...
public class ajouterOffervente extends AppCompatActivity {
    String[] typedebienarray = new String[]{"Appartement", "Maison", "Local Commercial","Terrain"};
    ...
    public SearchableSpinner regiondropdown,villedropdown;
    EditText numteltxt, nomtxt, prixtxt, remarquetxt;
    public SearchableSpinner nbchambredropdown,typedebiendropdown,etagedropdown;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajouter_offervente);
        typedebiendropdown = (SearchableSpinner) findViewById(R.id.spinnertypebien);
        ...
        regiondropdown = (SearchableSpinner) findViewById(R.id.spinnerregion);
        ...
        villedropdown = (SearchableSpinner) findViewById(R.id.spinnerville);
    ...
    public void clickback(View view) {
        Intent intent = new Intent(ajouterOffervente.this, ajouterdemandeoffer.class);
        startActivity(intent);
    }
    private void ajouteroffrevente() {
        ...
        offredevente offrevent = new offredevente(id, numtel, nom,typebien,nbchambre,nbetage,region,ville,prix,remarque,currentDateTimeString,username);
        databaseReference.child(id).setValue(offrevent);

        Toast.makeText(ajouterOffervente.this,
                "une offre de vente est ajouteé ",
                Toast.LENGTH_SHORT).show();
        }else {
            offredevente offrevente = new offredevente(numtel, nom, typebien, nbchambre, nbetage, region, ville,prix,remarque, currentDateTimeString, username);
            OffreVenteDAO dao = new OffreVenteDAO(ajouterOffervente.this);

            long idInsert = dao.insertOffreVente(offrevente);
            Toast.makeText(ajouterOffervente.this, "une offre de vente est ajouteé (HORS_LIGNE) ", Toast.LENGTH_SHORT).show();
        }
        ...
        if (PhonecallReceiver.fromDialog==true){
            ...
            Intent myintent = new Intent(ajouterOffervente.this, ajouterdemandeoffer.class);
    ...
    public void clickconfirmerajouteroffrevente (View view) {
        ajouteroffrevente();
