...
public class DemandeLocationContract {
    public static class DemandeLocationEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "DemandeLocation";
