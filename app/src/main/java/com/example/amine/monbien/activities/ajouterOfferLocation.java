...
public class ajouterOfferLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajouter_offer_location);
    ...
    public void clickback(View view) {
        Intent intent = new Intent(ajouterOfferLocation.this, ajouterdemandeoffer.class);
        startActivity(intent);
    }

    private void ajouteroffrelocation() {
        ...
        offredeLocation offreLocation = new offredeLocation(id, numtel, nom,typebien,nbchambre,nbetage,region,ville,prix,remarque,currentDateTimeString,username);
            databaseReference.child(id).setValue(offreLocation);

            Toast.makeText(ajouterOfferLocation.this,
                    "une offre de location est ajouteé ",
                    Toast.LENGTH_SHORT).show();
        }else {
            offredeLocation offrelocation = new offredeLocation(numtel, nom, typebien, nbchambre, nbetage, region, ville,prix,remarque, currentDateTimeString, username);
            OffreLocationDAO dao = new OffreLocationDAO(ajouterOfferLocation.this);

            long idInsert = dao.insertOffreLocation(offrelocation);
            Toast.makeText(ajouterOfferLocation.this, "une offre de location est ajouteé (HORS_LIGNE) ", Toast.LENGTH_SHORT).show();
        }
        if (PhonecallReceiver.fromDialog==true){
            ...
            Intent myintent = new Intent(ajouterOfferLocation.this, ajouterdemandeoffer.class);
            startActivity(myintent);
        }


    }
    public void clickconfirmerajouteroffrelocation (View view) {
        ajouteroffrelocation();
